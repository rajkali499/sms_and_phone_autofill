...
class _PhoneFieldHintState extends State<_PhoneFieldHint> {
  ...
  Widget build(BuildContext context) {
    ...
    return widget.child ??
        _createField(widget.isFormWidget, decoration, widget.validator, style);
  }
  ...
  Widget _createField(bool isFormWidget, InputDecoration decoration,
      FormFieldValidator? validator, TextStyle style) {
    return isFormWidget
        ? _createTextFormField(decoration, validator)
        : _createTextField(decoration, style);
  }

  Widget _createTextField(InputDecoration decoration, TextStyle style) {
    return TextField(
      autofocus: widget.autoFocus,
